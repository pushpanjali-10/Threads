...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("http://3.104.172.87:8080/login", user);
      if (res.status === 200) {
  ...
  return (
    <div className="h-screen w-screen bg-[#28282B]">
      <Toaster />
      <div
      ...
      >
        ...
        <div
          className="w-[90%] md:w-full bg-black 
        ...
        >
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-8 flex flex-col items-center justify-center ">
              ...
              <a
                className="text-sm text-gray-100 underline hover:text-gray-300 pt-2"
                href="/register"
              >
