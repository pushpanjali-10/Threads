...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("http://3.104.172.87:8080/signup", user);
      if (res.status === 201) {
  ...
  return (
    <div className="bg-[#28282B]">
      ...
      >
        <div>
          <a href="/">
            <h3 className="text-4xl font-bold text-white">Threads.</h3>
          </a>
        </div>
        <div
          ...
          <form>
            ...
            <div className="flex flex-col items-center justify-center mt-4">
              <button
                ...
                bg-black border border-transparent rounded-md 
                hover:bg-gray-800 false"
              >
                Register
              </button>
              <a
